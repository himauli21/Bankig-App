...
public class Money implements Comparable<Object> {
	...
	public double getUniversalValue() {
		// @TODO:  Fill in the code for this
		double rateOfCurrency = getCurrency().getRate();
		return getAmount() * rateOfCurrency;
	}
	...
	public boolean equals(Money other) {
		// @TODO:  Fill in the code for this
		if(other.currency.getRate() == this.currency.getRate())
		{
			return true;
		}
		else {
	...
	public Money add(Money other) {
		...
		return new Money(this.amount+other.currency.valueInUSD(other.amount) * this.currency.getRate(),this.currency);
	...
	public Money negate() {
		// @TODO:  Fill in the code for this
		return new Money(getAmount()*(-1),this.currency);
	}
	...
	public int compareTo(Object other) {
		...
		if(this.currency.getRate() == otherMoney.currency.getRate()) {
			return 0;
		}
		else if(this.currency.getRate() > otherMoney.currency.getRate()) {
			return 1;
		}
		else {
			return -1;
